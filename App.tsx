...
import { Send, User, Building2, Store, ArrowRight, Sparkles } from 'lucide-react';
...
function App() {
  ...
  const handleReset = () => {
    ...
    setResultUrl(null);
    setStep(0);
    setFormData({ personName: '', gender: '', businessName: '', businessType: '' });
    setImage(null);
    setIsKeyboardOpen(false);
  };
        ...
        return (
          <div className="space-y-6 animate-fade-in-up">
            <div>
              ...
              <p className="text-gray-500 text-sm mb-6">Helps us design the environment and props.</p>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
