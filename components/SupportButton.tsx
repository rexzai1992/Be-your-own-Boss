...
const SupportButton: React.FC<SupportButtonProps> = ({ isKeyboardOpen, settings }) => {
  ...
  // When keyboard open (z-60), we lift button to bottom-[350px] and z-70 to stay on top
  const positionClass = isKeyboardOpen ? 'bottom-[350px]' : 'bottom-6';
  const zIndexClass = isKeyboardOpen ? 'z-[70]' : 'z-50';
